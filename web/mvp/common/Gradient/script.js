...
function normalizeColor(hexCode) {
  ...
  class Gradient {
    ...
    */
    waitForCssVars() {
        if (this.computedCanvasStyle && -1 !== this.computedCanvasStyle.getPropertyValue("--color-brand1").indexOf("#")) this.init(), this.addIsLoadedClass();
        else {
    ...
    */
    initGradientColors() {
        this.sectionColors = ["--color-brand1", "--color-brand2", "--color-brand3", "--color-brand4"].map(cssPropertyName => {
